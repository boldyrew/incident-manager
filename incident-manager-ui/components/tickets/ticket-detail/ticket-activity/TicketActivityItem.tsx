...
export interface TicketActivityItemProps {
...
export function TicketActivityItem({ activity }: TicketActivityItemProps) {
      ...
      <div className="min-w-0 flex-1 pt-0.5">
        <div className="flex flex-wrap items-baseline justify-between gap-x-3 gap-y-1">
          <p className="text-sm text-foreground">
            ...
            <TicketActivityItemDescription activity={activity} />
          </p>
